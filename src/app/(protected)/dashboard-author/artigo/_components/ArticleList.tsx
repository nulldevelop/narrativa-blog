      ...
      <ScrollArea className="h-[600px]">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-black/[0.02] border-b border-black/5 sticky top-0 z-10">
                <th className="px-6 py-4 text-[0.6rem] font-black tracking-[0.2em] uppercase text-black/40 bg-black/[0.02]">
                  Título da Peça
                </th>
                <th className="px-6 py-4 text-[0.6rem] font-black tracking-[0.2em] uppercase text-black/40 bg-black/[0.02]">
                  Categoria
                ...
                <th className="px-6 py-4 text-[0.6rem] font-black tracking-[0.2em] uppercase text-black/40 text-right bg-black/[0.02]">
                  Ações
                </th>
              </tr>
            </thead>
