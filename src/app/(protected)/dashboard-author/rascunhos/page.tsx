...
export default async function AuthorDraftsPage() {
  ...
  // Busca apenas os rascunhos do autor logado
    ...
    <div className="min-h-screen bg-[#fcfcfc] pb-20">
        ...
        <div className="max-w-[1400px] mx-auto px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-[0.75rem] font-black tracking-[0.2em] uppercase text-black/60">
              Meus Rascunhos <span className="text-narrativa-vermelho ml-1">·</span> Textos em Elaboração
            </h1>
          </div>
          ...
          <div className="flex items-end justify-between flex-wrap gap-4 border-b border-black/10 pb-6">
            <div>
              <h2 className="font-heading text-[2rem] font-black text-narrativa-preto tracking-tight leading-none mb-2">
                Meus <em className="italic text-narrativa-vermelho font-serif">Rascunhos</em>
              </h2>
              <p className="text-[0.85rem] text-black/40 font-light">Continue trabalhando em seus textos ainda não publicados.</p>
            </div>
                        ...
                        <td className="px-6 py-5 text-right">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="rounded-none border-black/10 w-48">
                              ...
                              <DropdownMenuItem asChild className="cursor-pointer">
                                <Link href={`/dashboard-author/artigo/preview/${article.id}`} className="flex items-center">
                                  <Eye className="w-4 h-4 mr-3 text-black/40" /> Visualizar
                                </Link>
                              </DropdownMenuItem>
                            </DropdownMenuContent>
                          </DropdownMenu>
                    ...
                    <tr>
                      <td colSpan={5} className="px-6 py-20 text-center">
                        ...
                        <Button asChild variant="link" className="text-narrativa-vermelho text-[0.7rem] font-black uppercase tracking-widest mt-4">
                          <Link href="/dashboard-author/artigo/new">Criar nova matéria</Link>
                        </Button>
                      </td>
                    </tr>
                  )}
      ...
      <footer className="max-w-[1400px] mx-auto px-8 py-10 text-center">
         <p className="text-[0.6rem] tracking-[0.2em] uppercase text-black/20 font-bold">
           Narrativa Mesa Editorial · Gestão de Rascunhos
         </p>
      </footer>
    </div>
  );
